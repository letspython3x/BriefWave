...
class HTMLFormatter:
    ...
    def format_summary_to_html(title: str, summary: str, include_timestamp: bool = True) -> str:
        ...
        disclaimer = "This is an automated summary generated by an AI. Please verify information from original sources."
        ...
        <body>
            ...
            <div class="disclaimer">
                <p><em>Disclaimer: {EmailConfig.EMAIL_DISCLAIMER or disclaimer}.</em></p>
            </div>
        </body>
        </html>
        """
